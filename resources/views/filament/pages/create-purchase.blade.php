                ...
                <div class="purchase-table-container">
                    <table class="purchase-table">
                        ...
                        <tbody>
                                ...
                                <tr class="{{ $qty > 0 ? 'active-row' : '' }}" wire:key="row-{{ $product->id }}">
                                    ...
                                    <td>
                                        <div class="product-cell">
                                            @if($product->image)
                                                <img src="{{ Storage::disk('public')->url($product->image) }}" alt="{{ $product->name }}" class="product-img" />
                                            @else
                                            ...
                                            <div>
                                                ...
                                                <span class="product-category-sub">{{ $product->category->name ?? 'No Category' }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    {{-- Stock --}}
                                    <td style="text-align: center;">
                                        <span class="stock-status-badge {{ $isLow ? 'stock-status-low' : 'stock-status-safe' }}">
                                            {{ $product->stock }}
                                        </span>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" style="padding: 2rem; text-align: center;" class="product-category-sub">
                    ...
                    <div class="upload-container">
                        ...
                        @if($proofImage)
                            <div style="display: flex; flex-direction: column; align-items: center;">
                                <img src="{{ $proofImage->temporaryUrl() }}" style="max-height: 80px; object-fit: contain; border-radius: 0.375rem; border: 1px solid #e2e8f0;" />
                                <span style="font-size: 0.65rem; color: #10b981; font-weight: 700; margin-top: 0.25rem;">Selesai di-upload</span>
                            </div>
                        @else
                            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; color: #64748b; padding: 0.5rem 0;">
                                <svg class="w-8 h-8 mb-1 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 2rem; height: 2rem;">
