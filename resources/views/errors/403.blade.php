...
<head>
    ...
    <style>
        body { font-family: 'Outfit', sans-serif; background: #fff5f5; height: 100vh; margin: 0; display: flex; align-items: center; justify-content: center; color: #7f1d1d; text-align: center; }
        .container { padding: 2rem; max-width: 500px; animation: fadeIn 0.8s ease-out; }
        .error-code { font-size: 8rem; font-weight: 600; margin: 0; background: linear-gradient(135deg, #ef4444, #b91c1c); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
        h1 { font-size: 1.5rem; margin-top: 0; color: #991b1b; }
        p { color: #b91c1c; opacity: 0.8; line-height: 1.6; margin-bottom: 2rem; }
